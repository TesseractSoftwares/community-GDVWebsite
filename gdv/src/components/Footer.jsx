        ...
        <footer className="vgvalpo-bgcolor1 text-white px-6 text-center">
                    ...
                    <div className="footer-rrss">
                        ...
                        <ul className="footer-list">
                            <li className="mb-3 flex text-center gap-2">
                                <Link to={'https://discord.gg/7QCfZeeR5W'} target="_blank" className="bg-discord flex items-center justify-center w-9 h-9 rounded-lg transition duration-500 hover:-translate-y-1">
                                ...
                                <Link to={'https://www.instagram.com/gdvalparaiso/'} target="_blank" className="bg-instagram flex items-center justify-center w-9 h-9 rounded-lg transition duration-500 hover:-translate-y-1">
            ...
            <div className="my-border-top flex justify-center items-center">
                ...
                <p className="py-6 f-copy text-sm text-left">
                    GDValpo {new Date().getFullYear()}. Powered by <Link to={'https://www.tesseractsoftwares.com/'} target="_blank" className="tesseract-text">Tesseract&reg;</Link> 🚀
                </p>
            </div>
