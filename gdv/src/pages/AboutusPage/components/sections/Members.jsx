                            ...
                            members.map((m) => (
                                <div className="w-60 flex items-center text-center flex-col">
                                    ...
                                    <div className="flex justify-center items-center gap-2">
                                        <a href={m.facebooklink} target="_blank" rel="noopener noreferrer" className="bg-facebook flex items-center justify-center w-9 h-9 rounded-lg transition duration-500 hover:-translate-y-1">
                                        ...
                                        <a href={m.instagramlink} target="_blank" rel="noopener noreferrer" className="bg-instagram flex items-center justify-center w-9 h-9 rounded-lg transition duration-500 hover:-translate-y-1">
